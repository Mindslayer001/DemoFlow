...
export function HeroSection() {
    ...
    // Generate particles data once and memoize it to prevent regeneration
    ...
    }, [isClient]) // Only regenerate when isClient changes

    // Generate orbs data once and memoize it
                ...
                {particlesData.map((particle) => (
                    <div
                        ...
                        style={{
                            ...
                            background: `hsl(${particle.hue}, 80%, ${particle.lightness}%)`,
