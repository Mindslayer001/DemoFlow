...
const nodeTypes = [
  {
    ...
    description: 'Connect to any database with visual query builders',
    color: 'from-blue-500 to-cyan-500',
    codeSnippet: `// Auto-generated database connection
...
await db.posts.create({
  ...
  },
  {
    ...
    codeSnippet: `// Generated REST endpoint
app.get('/api/users/:id', async (req, res) => {
  ...
  },
  {
    ...
    description: 'Complete auth system with OAuth, JWT, and 2FA',
    color: 'from-purple-500 to-pink-500',
    codeSnippet: `// Authentication middleware
const authenticateUser = (req, res, next) => {
  ...
  next()
    ...
    features: ['OAuth Integration', 'JWT Tokens', '2FA Support', 'Role Management']
  },
  {
    id: 'functions',
    icon: Zap,
    title: 'Cloud Functions',
    description: 'Serverless functions for custom business logic',
    color: 'from-yellow-500 to-orange-500',
    codeSnippet: `// Serverless function
export const processPayment = async (data) => {
  ...
  },
  {
    ...
    codeSnippet: `// Email notification
await sendEmail({
  to: user.email,
  template: 'welcome',
  data: { name: user.name }
...
const payment = await processPayment({
  ...
  },
  {
    ...
    description: 'Complete user lifecycle and profile management',
    color: 'from-teal-500 to-green-500',
    codeSnippet: `// User management
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <motion.div
                        ...
                        className={`w-12 h-12 mb-4 rounded-xl bg-gradient-to-br ${node.color} flex items-center justify-center shadow-lg`}
                      >
                  ...
                  >
                    ...
                    <div className="mb-4 flex-1">
                      <h4 className="text-sm font-semibold text-primary-400 mb-3">Code Preview</h4>
                      <div className="bg-black/50 rounded-lg p-3 text-xs font-mono text-green-400 overflow-hidden">
